  ...
  return (
    <nav className="bg-gray-800 text-white p-4 shadow-md">
      ...
      <div className="text-2xl font-bold">
        {/* The 'to' prop in a Link component specifies the destination path */}
        ...
        {isAuthenticated ? (
          <>
            ...
            <li>
              <button onClick={handleLogout}  className="bg-blue-500 hover:bg-blue-600 px-3 py-1 rounded-md text-sm">
                Logout
              </button>
            </li>
          </>
